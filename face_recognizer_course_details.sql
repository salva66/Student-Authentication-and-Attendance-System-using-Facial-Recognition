...
CREATE TABLE `course_details` (
  `prog_codeL` char(5) NOT NULL,
  `prog_codeN` int NOT NULL,
  `program` varchar(45) NOT NULL,
  `course_name` varchar(45) NOT NULL,
  PRIMARY KEY (`prog_codeL`,`prog_codeN`)
...
INSERT INTO `course_details` VALUES ('CS',1,'BSc CE','CS430'),('CS',2,'BSc CS','CS430'),('TN',1,'BSc TE','TN 430');
